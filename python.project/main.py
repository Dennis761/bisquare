...
#3. Оскільки я не міг одразу виписати в змінну D_sqrt корінь квадратний дискримінанта, тобто деякого
# число d (тому що був ризик того, що дискримінант буде від'ємний і виникне помилка,
...
# останню частину кодy, яка перевіряла наш вираз на кількість дійсних чисел,
# я зміг вивести кількість коренів біквадратного рівяння взалежності від його коефіціентів
# Висновок: за допомогою цього завдання я успішно навчився використовувати
